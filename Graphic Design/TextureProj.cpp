...
void key_callback(GLFWwindow* window, int key, int scancode, int action, int mods) {
    ...
    case GLFW_KEY_UP:
        viewAzimuth = Min(viewAzimuth + 0.1, PIhalves - 0.05);
        viewChanged = true;
        break;
    case GLFW_KEY_DOWN:
        viewAzimuth = Max(viewAzimuth - 0.1, -PIhalves + 0.05);
        viewChanged = true;
        break;
    case GLFW_KEY_RIGHT:
        viewDirection += 0.1;
...
int main() {
    ...
    printf("Press 'L' key to turn on TV and change channel.\n");
    printf("Press 'K' key to turn off TV.\n");
    printf("Press 'Y' key to move roomba forward.\n");
    printf("Press 'G' key to move roomba left.\n");
    printf("Press 'H' key to move roomba backward.\n");
    printf("Press 'J' key to move roomba right.\n");
